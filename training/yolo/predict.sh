...
CHECKPOINTS=(
    "weight/delete_cam5_25_weight/epoch25.pt"
)

# Danh sách các file output
OUTPUTS=(
    "../../inference/results/delete_cam5_25_weight.txt"
)
...
run_task() {
    ...
    CUDA_VISIBLE_DEVICES="$gpu_id" python3 predict.py --checkpoint_file "$checkpoint_file" --input_dir ../../data/public_test --output_file "$output_file"
}
